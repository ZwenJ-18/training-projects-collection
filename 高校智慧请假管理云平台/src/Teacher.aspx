...
<body>
    <form runat="server">
        ...
        <div class="sidebar glass">
            <div class="drawer-header">
                <div class="drawer-avatar" id="drawerAvatar">辅</div>
                <div class="drawer-name" id="drawerName">辅导员</div>
                <div class="drawer-role" id="drawerRole">辅导员</div>
            </div>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="approval-actions">
                                        <asp:Button runat="server" CssClass="btn-action btn-approve" CommandName="Approve" CommandArgument='<%# Eval("LeaveId") %>' OnClientClick="return confirm('确定要通过这条请假申请吗？');" Text="通过" />
                                        <asp:Button runat="server" CssClass="btn-action btn-reject" CommandName="Reject" CommandArgument='<%# Eval("LeaveId") %>' OnClientClick="return confirm('确定要拒绝这条请假申请吗？');" Text="拒绝" />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
    ...
    <script>
        ...
        (function() {
            ...
            var teacherName = document.getElementById('<%= lblTeacherName.ClientID %>');
            ...
            if (teacherName && avatarEl) avatarEl.textContent = (teacherName.textContent || teacherName.innerText || '辅').charAt(0);
            if (teacherName && nameEl) nameEl.textContent = teacherName.textContent || teacherName.innerText || '辅导员';
            if (roleEl) roleEl.textContent = '辅导员';
