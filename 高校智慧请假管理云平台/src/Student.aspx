...
<body>
    <form runat="server">
        ...
        <div class="sidebar glass">
            ...
            <div class="drawer-header">
                <div class="drawer-avatar" id="drawerAvatar">学</div>
                <div class="drawer-name" id="drawerName">学生</div>
                <div class="drawer-role" id="drawerRole">学生</div>
            </div>
            ...
            <div id="apply" class="content-section active">
                <div class="card-grid">
                    ...
                    <div class="card glass">
                        ...
                        <asp:Button ID="btnSubmit" runat="server" Text="提交申请" CssClass="btn btn-primary btn-submit-mobile" OnClick="btnSubmit_Click" />
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        (function() {
            ...
            // 填充抽屉头部信息
            var userName = document.getElementById('<%= lblName.ClientID %>');
            var roleText = '学生';
            ...
            if (userName && avatarEl) avatarEl.textContent = (userName.textContent || userName.innerText || '学').charAt(0);
            if (userName && nameEl) nameEl.textContent = userName.textContent || userName.innerText || '学生';
        ...
        function switchTab(tabId) {
            ...
            var targetItem = document.querySelector('.sidebar-item[onclick*="switchTab(\'' + tabId + '\')"]');
